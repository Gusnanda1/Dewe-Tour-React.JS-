...
function Payment_pay() {
  ...
  return (
    <div style={{ width: "100%", backgroundColor: "whitesmoke" }}>
      ...
      <Modal size="l" show={showModal} onHide={HandleCloseModal}>
        <Modal.Body style={{ color: "Black", textAlign: "center" }}>
          <p style={{ fontSize: "23px", color: "black" }}>
            Your payment confirmed within 1 x 24 hours To see orders click{" "}
            <Link
              to={"/Payment-pending"}
      ...
      <footer>
        ...
        <img
          src={daun_img}
          style={{ position: "absolute", bottom: "-139px", left: "1225px" }}
        />
      </footer>
    </div>
  );
